        ...
        <div key={b.data.judul} className='m-10 border border-solid rounded shadow-md hover:shadow-sm max-w-3xl p-3'>
          <Link href={`/berita/${b.uid}`} className="no-underline text-black">
            ...
            <div className='border border-solid border-x-0 border-b-transparent relative z-10 text-justify p-2'>
              <Image src={b.data.berita.filter((data: any) => data.type === 'image')[0].url} className="relative float-left mr-2.5 w-full rounded md:w-1/2 h-1/2" alt="" width={337} height={200} />
