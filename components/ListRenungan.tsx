import styles from '@/styles/ListRenungan.module.css';
import Link from 'next/link';

function ListRenungan() {
  return (
    <>
      <div className={styles["container"]}>
        <div className={styles["title"]}>Renungan Khotbah Minggu</div>
        <div className={styles["subtitle"]}>GBKP Klasis Medan Kutajurung</div>
        <div className={styles["list"]}>
          <Link className={styles["border"]} href="/kategorial/renungan/bahan-pa/renungan-1">
            <div className={styles.item}>Renungan 1</div>
          </Link>
          <Link className={styles["border"]} href="/kategorial/renungan/bahan-pa/renungan-2">
            <div className={styles.item}>Renungan 2</div>
          </Link>
          <Link className={styles["border"]} href="/kategorial/renungan/bahan-pa/renungan-2">
            <div className={styles.item}>Renungan 2</div>
          </Link>
          ...
          <Link className={styles["border"]} href="/kategorial/renungan/bahan-pa/renungan-2">
            <div className={styles.item}>30 Des 2023</div>
          </Link>
        </div>
